...
const addOns = [
  ...
  { name: "Head Tension Massage | 10mins | £40", desc: "Relieves scalp, temple, and head tension" },
  { name: "Extra Hands | 10mins| £35", desc: "Enhanced relaxation with additional massage techniques" },
