...
const addOns = [
  {
    name: "Buccal Massage",
    desc: "Releases deep jaw and facial tension",
  },
  {
    name: "Facial Cupping",
    desc: "Stimulates circulation and lymphatic drainage",
  },
  {
    name: "Head Tension Massage — 10 min",
    desc: "Relieves scalp, temple, and head tension",
  },
  {
    name: "Extra Hands",
    desc: "Enhanced relaxation with additional massage techniques",
  },
];
